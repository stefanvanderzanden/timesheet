...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeelTaak.verwachte_tijd'
        db.add_column(u'entries_deeltaak', 'verwachte_tijd',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeelTaak.verwachte_tijd'
        db.delete_column(u'entries_deeltaak', 'verwachte_tijd')
    ...
    models = {
        ...
        u'entries.deeltaak': {
            ...
            'verwachte_tijd': ('django.db.models.fields.IntegerField', [], {})
        },
        u'entries.project': {
